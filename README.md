...
- GCP unilaterally deprecates models (with 2 weeks notice) to more expensive models with worse performance. GCP representatives just shrug. relying on GCP is a risk to your business.
